...
namespace XAFSaveImageToDB.Blazor.Server {
    public partial class XAFSaveImageToDBBlazorApplication : BlazorApplication {
        public XAFSaveImageToDBBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XAFSaveImageToDBBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
